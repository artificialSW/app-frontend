...
class MockDataManager {
  ...
  List<ArchiveFlowerResponseDto> _getSecondTreeData(int year, int month, int period) {
    ...
    if (month == 5) {
      if (period == 1) {
        data.addAll([
          ArchiveFlowerResponseDto(flowerId: 1, flowerName: 'acacia', archivedAt: '2025-05-02T00:00:00Z'),
          ArchiveFlowerResponseDto(flowerId: 2, flowerName: 'plum_blossom', archivedAt: '2025-05-04T00:00:00Z'),
          ArchiveFlowerResponseDto(flowerId: 3, flowerName: 'plum_blossom', archivedAt: '2025-05-06T00:00:00Z'),
          ArchiveFlowerResponseDto(flowerId: 4, flowerName: 'acacia', archivedAt: '2025-05-08T00:00:00Z'),
        ...
        data.addAll([
          ArchiveFlowerResponseDto(flowerId: 9, flowerName: 'acacia', archivedAt: '2025-05-18T00:00:00Z'),
          ArchiveFlowerResponseDto(flowerId: 10, flowerName: 'plum_blossom', archivedAt: '2025-05-20T00:00:00Z'),
