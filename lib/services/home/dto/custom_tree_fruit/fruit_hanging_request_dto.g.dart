...
FruitHangingRequestDto _$FruitHangingRequestDtoFromJson(Map<String, dynamic> json) =>
    FruitHangingRequestDto(
      fruitHanging: (json['fruit-hanging'] as List<dynamic>)
          .map((e) => FruitHangingItem.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$FruitHangingRequestDtoToJson(FruitHangingRequestDto instance) =>
    <String, dynamic>{
      'fruit-hanging': instance.fruitHanging,
    };
